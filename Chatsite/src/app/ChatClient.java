...
public class ChatClient {
    ...
    public static void main(String[] args) {
        new ChatClient("127.0.0.1", 5000); //localhost/server. for testing, don't mess with the IP address, but port can basically be whatever as long as it matches the one in ChatServer.java
    }
}
